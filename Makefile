...
# Docker test images
docker-images: docker/.ubuntu24 docker/.amazonlinux2023 docker/.debian docker/.fedora
...
clean:
	rm -f docker/.ubuntu24 docker/.amazonlinux2023 docker/.debian docker/.fedora
